...
import { FullsreenControl } from "./fullscreen-control";
  ...
  return (
    <div className="relative h-full" ref={wrapperRef}>
      ...
      <div className="absolute top-0 h-full w-full opacity-0 hover:opacity-100 transition-all">
        <div className="absolute bottom-0 flex h-14 w-full items-center justify-between bg-graadient-to-r from-neutral-900 px-4 ">
